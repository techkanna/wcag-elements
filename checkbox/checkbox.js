  ...
  template.innerHTML = `
    <style>
      :host {
        ...
        background: url('/checkbox/images/unchecked-checkbox.svg') no-repeat;
      ...
      :host([checked]) {
        background: url('/checkbox/images/checked-checkbox.svg') no-repeat;
        background-size: contain;
      }
      :host([disabled]) {
        background:
          url('/checkbox/images/unchecked-checkbox-disabled.svg') no-repeat;
        background-size: contain;
      }
      :host([checked][disabled]) {
        background:
          url('/checkbox/images/checked-checkbox-disabled.svg') no-repeat;
        background-size: contain;
      }
    </style>
  `;
