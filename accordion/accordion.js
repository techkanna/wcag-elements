(function () {
  ...
  class HowtoAccordion extends HTMLElement {
    ...
    _animatePanelForHeading(heading, expand) {
      ...
      if (expand) {
        ...
        this._animateOut(panel).then((_) => this._collapsePanel(panel));
      }
    }
    ...
    _prevHeading() {
      ...
      // element.
      let newIdx =
        headings.findIndex((headings) => headings === document.activeElement) -
        1;
  ...
  window.customElements.define('howto-accordion-panel', HowtoAccordionPanel);
